...
if test -f ${DESTDIR}/home/chandy/project/psandbox/apache/apache2/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/chandy/project/psandbox/apache/apache2/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/chandy/project/psandbox/apache/apache2/bin/apu-1-config
else
...
test -n "/home/chandy/project/psandbox/apache/apache2/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/chandy/project/psandbox/apache/apache2/build"
